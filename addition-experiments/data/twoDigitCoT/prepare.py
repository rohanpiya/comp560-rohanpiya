...
from cotGenerators import generate2DigitSimpleCoTExample
from cotGenerators import generate2DigitCarryCoTExample

num_examples = 100000  # or whatever gives ~1.2M chars
num_no_carry = int(0.95 * num_examples)
...
while total_no_carry_length < num_no_carry:
    example = generate2DigitSimpleCoTExample()
    lines.append(example)
    total_no_carry_length += len(example)

while total_carry_length < num_carry:
    example = generate2DigitCarryCoTExample()
    lines.append(example)
