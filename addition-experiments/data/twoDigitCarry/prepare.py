...
from generators import generate2DigitSimpleExamples
from generators import generate2DigitCarryExamples
...
while total_no_carry_length < num_no_carry:
    example = generate2DigitSimpleExamples()
    lines.append(example)
    total_no_carry_length += len(example)

while total_carry_length < num_carry:
    example = generate2DigitCarryExamples()
    lines.append(example)
