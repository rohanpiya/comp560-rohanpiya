...
I ran a series of small experiments to test whether the model could learn how commas, semicolons, and dollar signs behave in structured data, using only pattern recognition and limited computing power on a MacBook.
...
**Data:**
- Each line follows this format: ```abc,def;```
...
**Result:**
The model did not always generate correct names, but it consistently placed semicolons before newlines. This shows it learned structural rules even when the content was noisy.
